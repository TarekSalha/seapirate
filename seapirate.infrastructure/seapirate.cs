...
class SeaPirateApp : Stack
{
    public SeaPirateApp()
    {
        ...
        var connectionString = Output.Tuple(sqlServer.Name, sqlDatabase.Name).Apply(names =>
            $"Server=tcp:{names.Item1}.database.windows.net,1433;Initial Catalog={names.Item2};Persist Security Info=False;User ID=adminuser;Password=Password123!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
